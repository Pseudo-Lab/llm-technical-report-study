...
- [ ] **V4가 여러 specialist의 full-vocabulary OPD 신호를 hidden-state cache와 teacher별 batch scheduling으로 처리하는 방식을 설명할 수 있다.**
  ...
  - **함께 읽을 자료와 범위:** V4가 인용한 [MiniLLM v1](https://arxiv.org/abs/2306.08543v1) §2.1–§2.2, 식 (1)–(7)로 reverse-KL과 student-sampled optimization을 확인한다. W08의 MiMo가 ORM/GRPO outcome advantage를 결합하는 경우와 달리, 이 목표의 중심은 V4 자체의 full-vocabulary OPD scheduling이다.
