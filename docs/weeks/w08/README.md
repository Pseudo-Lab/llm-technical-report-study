...
- arXiv: [MiMo](https://arxiv.org/abs/2505.07608v2) → [MiMo-V2-Flash](https://arxiv.org/abs/2601.02780v2)
...
- [ ] MiMo가 reasoning pattern을 잃지 않도록 extraction·dedup·quality tagging·3-stage mixture를 어떻게 조합했고, MTP를 학습용 1개 layer와 추론용 여러 draft layer로 왜 나눴는지 설명할 수 있다.
  ...
  - **함께 읽을 자료와 범위:** [W08 개념 경로 §1–§2](../../background/w08.md#mimo-pretraining) → MiMo가 직접 인용한 [MTP §2·§3.2](https://arxiv.org/abs/2404.19737v1). GQA·RMSNorm·SwiGLU·RoPE는 이 보고서의 새 제안이 아니므로 [W01](../../background/w01.md)·[W03](../../background/w03.md)에서 필요한 만큼만 복습한다.
  - **원문에서 읽을 부분:** [MiMo §2.1–§2.3, Fig. 2](https://arxiv.org/pdf/2505.07608v2).
...
- [ ] MiMo가 verifier-RL에서 code test 난도, dynamic sampling, easy-data re-sampling, Seamless Rollout Engine을 왜 함께 설계했는지 설명할 수 있다.
  ...
  - **원문에서 읽을 부분:** [MiMo §3.1–§3.4.1, Fig. 5–6, §3.6](https://arxiv.org/pdf/2505.07608v2).
...
- [ ] Flash가 MiMo의 dense GQA model을 hybrid SWA/GA·lightweight MTP로 바꾸고, domain teacher MOPD와 MoE rollout system을 어떻게 결합했는지 설명할 수 있다.
  ...
  - **함께 읽을 자료와 범위:** [W08 개념 경로 §4](../../background/w08.md#flash-changes) → SWA/GA의 [Longformer §3–§3.1](https://arxiv.org/abs/2004.05150v2), sink의 [gpt-oss model card §2.2](https://arxiv.org/pdf/2508.10925v1), student rollout distillation의 [On-Policy Distillation §2–§3](https://arxiv.org/pdf/2306.13649v3). 각각 Flash가 본문에서 직접 인용한 배경이며, MOPD 자체는 Flash의 조합이다.
  - **원문에서 읽을 부분:** [MiMo-V2-Flash §2.1–§2.3, Fig. 2, 식 (1)–(4), §4.1·§4.4 식 (5)–(9), §4.6, §5.1–§5.2](https://arxiv.org/pdf/2601.02780v2).
...
- [On-Policy Distillation of Language Models](https://arxiv.org/abs/2306.13649v3)
- [gpt-oss-120b & gpt-oss-20b Model Card](https://arxiv.org/abs/2508.10925v1)
