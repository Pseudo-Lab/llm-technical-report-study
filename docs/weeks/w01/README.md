...
- 논문: LLaMA 1 → Llama 2
- arXiv: [LLaMA 1](https://arxiv.org/abs/2302.13971) → [Llama 2](https://arxiv.org/abs/2307.09288)
- 핵심 주제: Transformer block · RoPE가 Q/K 내적에 상대 위치를 반영하는 원리 · MHA/GQA의 KV 공유 · SFT와 보상 학습
- 모임 날짜: 추후 안내
- 주간 편집자: 추후 안내
