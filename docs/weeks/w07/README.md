...
[주차 목록](../README.md) · [배경 개념과 읽기 순서](../../background/README.md) · [W07 전체 개념 경로](../../background/w07.md) · [주간 템플릿](../../../templates/week.md)
...
- [ ] MiMo가 reasoning pattern을 잃지 않도록 extraction·dedup·quality tagging·3-stage mixture를 어떻게 조합했고, MTP를 학습용 1개 layer와 추론용 여러 draft layer로 왜 나눴는지 설명할 수 있다.
  ...
  - **함께 읽을 자료와 범위:** [W07 개념 경로 §1–§2](../../background/w07.md#mimo-pretraining) → MiMo가 직접 인용한 [MTP v1 §2·§3.2](https://arxiv.org/abs/2404.19737v1). GQA·RMSNorm·SwiGLU·RoPE는 이 보고서의 새 제안이 아니므로 [W01](../../background/llama.md)·[W02](../../background/qwen.md)에서 필요한 만큼만 복습한다.
...
- [ ] MiMo가 verifier-RL에서 code test 난도, dynamic sampling, easy-data re-sampling, Seamless Rollout Engine을 왜 함께 설계했는지 설명할 수 있다.
  ...
  - **함께 읽을 자료와 범위:** [W07 개념 경로 §3](../../background/w07.md#mimo-verifier-rl) → MiMo §3.1–§3.4. GRPO 기본식은 [W06](../../background/w06.md#verifiable-rl)에서 가져오되, MiMo의 reward/sampling/engine을 R1 recipe로 바꾸어 쓰지 않는다.
...
- [ ] Flash가 MiMo의 dense GQA model을 hybrid SWA/GA·lightweight MTP로 바꾸고, domain teacher MOPD와 MoE rollout system을 어떻게 결합했는지 설명할 수 있다.
  ...
  - **함께 읽을 자료와 범위:** [W07 개념 경로 §4](../../background/w07.md#flash-changes) → SWA/GA의 [Longformer v2 §3–§3.1](https://arxiv.org/abs/2004.05150v2), sink의 [gpt-oss model card v1 §2.2](https://arxiv.org/pdf/2508.10925v1), student rollout distillation의 [On-Policy Distillation v3 §2–§3](https://arxiv.org/pdf/2306.13649v3). 각각 Flash가 본문에서 직접 인용한 배경이며, MOPD 자체는 Flash의 조합이다.
